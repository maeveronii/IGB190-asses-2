...
{
    /// <summary>
    /// Disable the specified game object, using the specified settings.
    /// </summary>
    [System.Serializable]
    public class DisableGameObject : FeedbackItem
    {
        /// <summary>
        ...
        public override void DrawUI(GameFeedback target)
        {
            ...
            {
                EditorGUILayout.HelpBox("You must assign a valid tag for the GameObject to disable.", MessageType.Error);
                hasError = true;
            }
        }
